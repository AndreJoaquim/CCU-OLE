    ...
    <body>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        ?>
                                ...
                                <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Olá
        ...
        <div class="container">
            ...
            if(!$hasCourseId || $resultCourse=="NO_COURSE_BY_ID"){//Without or Invalid ID
                ...
                echo "    <div id=\"course-image\" class=\"col-lg-4 col-md-4 col-sm-4 col-xs-4\">";
                echo "        <img class=\"img-responsive\" src=\"" . $resultCourse['image'] ."\" alt=\"\">";
                echo "    </div>";
                echo "    <div id=\"course-description\" class=\"col-lg-8 col-md-8 col-sm-8 col-xs-8\">";
                echo "        <h2>Descrição</h2>";
                echo "        <p>" . $resultCourse['description'] . "</p>";
                echo "        <div>";
                echo "            <h3>Autor: <small>" . $resultCourse['author'] . "</small></h3>";
                echo "            <h3>Dificuldade: <small>" . transalateDifficulty($resultCourse['difficulty']) . "</small></h3>";
                echo "        </div>";
                echo "    </div>";
                echo "</div>";
                ...
                if($_COOKIE['user'] == "@convidado@" ){

                    //Utilizador Convidado

                    echo "        <div id=\"sign-in-course\">";
                    echo "            <a class=\"btn btn-success btn-block btn-lg\" href=\"register.php\">Para ver este curso precisa de estar registado! Clique para se registar!</a>";
                    echo "        </div>";

                } elseif(!isUserEnrolledInCourse($_COOKIE['user'], $_GET['id']) ){

                    //Utilizador não registado no curso
                    echo "        <div id=\"sign-in-course\">";
                    ...
                    $lessons = getUserLessonByCourse($_COOKIE['user'], $_GET['id']);
                    ...
                    foreach ($lessons as $lesson) {
                        ...
                        echo "            <tr>";
                        echo "                <td>" . $lesson['lessonName'] . "</td>";
                        
                        if($lesson['lessonCompleted'] == 0){
                            echo "            <td class=\"align-right\"><a class=\"btn btn-success\" href=\"lesson.php?id=" . $lesson['lessonId'] . "\">Ver Lição</a></td>";
                        }else{
                            echo "            <td class=\"align-right\"><a class=\"btn btn-success\" href=\"lesson.php?id=" . $lesson['lessonId'] . "\">Rever Lição</a></td>";
                        }
